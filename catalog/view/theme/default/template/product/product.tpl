<?php echo $header; ?>
    ...
    <article id="content" class="span9">
        ...
        <div class="right span7">
          ...
          <div class="cart">
            <div><?php echo $text_qty; ?>
              ...
              &nbsp;
              <input type="button" value="<?php echo $button_cart; ?>" id="button-cart" class="btn btn-primary" />
      ...
      <div id="tab-attribute" class="tab-content">
        <table class="attribute table table-hover">
      ...
      <div class="box">
        ...
        <div class="box-product row-fluid">
          ...
          <div class="span3">
            ...
            <?php } ?>
            <a onclick="addToCart('<?php echo $product['product_id']; ?>');" class="btn btn-primary"><?php echo $button_cart; ?></a></div>
          <?php } ?>
        </div>
      </div>
      <?php } ?>
