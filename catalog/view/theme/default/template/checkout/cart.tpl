...
<div class="span12">
  ...
  <div class="buttons">
    <div class="right"><a href="<?php echo $checkout; ?>" class="btn btn-primary pull-right"><?php echo $button_checkout; ?></a></div>
    <div class="center"><a href="<?php echo $continue; ?>" class="btn pull-left"><?php echo $button_shopping; ?></a></div>
  </div>
