...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a onclick="$('#restore').submit();" class="btn btn-primary"><?php echo $button_restore; ?></a><a onclick="$('#backup').submit();" class="btn btn-primary"><?php echo $button_backup; ?></a></div>
    </div>
    <div class="content">
