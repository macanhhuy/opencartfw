        ...
        <div id="tab-attribute">
          <table id="attribute" class="list">
            ...
            <tbody id="attribute-row<?php echo $attribute_row; ?>">
              <tr>
                ...
                <td class="left"><?php foreach ($languages as $language) { ?>
                  ...
                  <?php } ?></td>
                <td class="left"><a onclick="$('#attribute-row<?php echo $attribute_row; ?>').remove();" class="btn btn-primary"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $attribute_row++; ?>
            <?php } ?>
            <tfoot>
              <tr>
                <td colspan="2"></td>
                <td class="left"><a onclick="addAttribute();" class="btn btn-primary"><?php echo $button_add_attribute; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
          ...
          <div id="tab-option-<?php echo $option_row; ?>" class="vtabs-content">
            ...
            <table id="option-value<?php echo $option_row; ?>" class="list">
              ...
              <tfoot>
                <tr>
                  <td colspan="6"></td>
                  <td class="left"><a onclick="addOptionValue('<?php echo $option_row; ?>');" class="btn btn-primary"><?php echo $button_add_option_value; ?></a></td>
                </tr>
              </tfoot>
            </table>
          ...
          <table id="discount" class="list">
            ...
            <tbody id="discount-row<?php echo $discount_row; ?>">
              <tr>
                ...
                <td class="left"><a onclick="$('#discount-row<?php echo $discount_row; ?>').remove();" class="btn btn-primary"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $discount_row++; ?>
            <?php } ?>
            <tfoot>
              <tr>
                <td colspan="6"></td>
                <td class="left"><a onclick="addDiscount();" class="btn btn-primary"><?php echo $button_add_discount; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
          ...
          <table id="special" class="list">
            ...
            <tbody id="special-row<?php echo $special_row; ?>">
              <tr>
                ...
                <td class="left"><a onclick="$('#special-row<?php echo $special_row; ?>').remove();" class="btn btn-primary"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $special_row++; ?>
            <?php } ?>
            <tfoot>
              <tr>
                <td colspan="5"></td>
                <td class="left"><a onclick="addSpecial();" class="btn btn-primary"><?php echo $button_add_special; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
        <div id="tab-image">
          <table id="images" class="list">
            ...
            <tfoot>
              <tr>
                <td colspan="2"></td>
                <td class="left"><a onclick="addImage();" class="btn btn-primary"><?php echo $button_add_image; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
...
function addAttribute() {
    ...
    <?php } ?>
	html += '    </td>';
	html += '    <td class="left"><a onclick="$(\'#attribute-row' + attribute_row + '\').remove();" class="btn btn-primary"><?php echo $button_remove; ?></a></td>';
    html += '  </tr>';	
    html += '</tbody>';
...
$('input[name=\'option\']').catcomplete({
	...
	select: function(event, ui) {
		...
		if (ui.item.type == 'select' || ui.item.type == 'radio' || ui.item.type == 'checkbox' || ui.item.type == 'image') {
			...
			html += '        <td class="left"><a onclick="addOptionValue(' + option_row + ');" class="btn btn-primary"><?php echo $button_add_option_value; ?></a></td>';
			html += '      </tr>';
			html += '    </tfoot>';
			html += '  </table>';
...
function addDiscount() {
	...
	html += '    <td class="left"><a onclick="$(\'#discount-row' + discount_row + '\').remove();" class="btn btn-primary"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';	
    html += '</tbody>';
...
function addSpecial() {
	...
	html += '    <td class="left"><a onclick="$(\'#special-row' + special_row + '\').remove();" class="btn btn-primary"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
    html += '</tbody>';
